...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfname,tffname,tfsalary,tfaddress,tfphone,tfemail,tfdesig,tfadhaar;
    JDateChooser dcdob;
    JComboBox education;
    JLabel lblempid;
     JButton add,back;       
    ...
    public void actionPerformed(ActionEvent ae){
         if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "insert into employe values('"+name+"', '"+fname+"', '"+dob+"', '"+salary+"', '"+address+"', '"+phone+"', '"+email+"', '"+edu+"', '"+designation+"', '"+adhaar+"', '"+empid+"')";
